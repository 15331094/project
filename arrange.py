...
def get_product_info():
	#酒柜
	Gradevins_base_dir = "/var/www/demoapp/project/static/resources/Gradevin6.16"
	...
	for each_product in Gradevins:
		...
		pic_urls_list = []
		for pic_url in imgs:
			pic_urls_list.append(Gradevins_base_dir[25:] + "/" + each_product + "/" + pic_url)
	...
	#留声机
	Phonographs_base_dir = "/var/www/demoapp/project/static/resources/Phonograph6.16"
	...
	for each_product in Phonographs:
		...
		pic_urls_list = []
		for pic_url in imgs:
			pic_urls_list.append(Phonographs_base_dir[25:] + "/" + each_product + "/" + pic_url)
		description = ""
		new_Phonographs = product(name, pic_urls_list, description)
		Phonographs_list.append(new_Phonographs)
	#留声机6.17
	Phonographs_base_dir = "/var/www/demoapp/project/static/resources/Phonograph6.17"
	Phonographs = os.listdir(Phonographs_base_dir)
